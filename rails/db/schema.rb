...
ActiveRecord::Schema.define(:version => 20110310000349) do
  ...
  add_index "cat_news", ["category_id", "date_stamp", "news_item_id"], :name => "cdn_index"
  ...
  create_table "downloaded_news_items", :id => false, :force => true do |t|
  ...
  add_index "news_item_url_md5_hashes", ["url_hash"], :name => "url_hash_index"
  ...
  add_index "news_items", ["primary_news_index_id"], :name => "niKeyIndex"
  ...
  add_index "sources", ["user_id"], :name => "fk_sources_2"
